...
<div className="relative  h-full w-full">
          ...
          <div className="absolute top-0 left-0 z-10 h-full w-full flex justify-center items-center ">
            ...
            className="h-[90%] w-10 rounded-full bg-linear-to-r from-[#70FFC1] via-[#adebd0] to-[#70FFC1] shadow-xl">
            ...
            className="h-[95%] w-10 rounded-full bg-linear-to-r from-[rgb(249,192,167)] via-[rgb(252,203,182)] to-[rgb(249,192,167)] shadow-xl">
              <div className="flex flex-col justify-center items-center h-full">
            ...
            className="h-[100%] w-10 rounded-full bg-linear-to-r from-[#FF579F] via-[#e96da3] to-[#FF579F] shadow-sxl">
              <div className="flex flex-col justify-center items-center h-full">
            ...
            animate={{y:[-10,10,-10]}}
            transition={{duration:5,repeat:Infinity}}
            className="h-[95%] w-10 rounded-full bg-linear-to-r from-[#CD8FFE] via-[#d6a9f9] to-[#CD8FFE] shadow-xl">
              <div className="flex flex-col justify-center items-center h-full">
              <div className="uppercase text-center text-black ">o</div>
              <div className="uppercase text-center text-black ">n</div>
              <div className="uppercase text-center text-black ">e</div>
            ...
            animate={{y:[-10,10,-10]}}
            transition={{duration:6,repeat:Infinity}}
            className="h-[90%] w-10 rounded-full bg-linear-to-r from-[#9FB5FE] via-[#adc1fc] to-[#9FB5FE] shadow-xl">
              <div className="flex flex-col justify-center items-center h-full">
              <div className="uppercase text-center text-black ">e</div>
              <div className="uppercase text-center text-black ">_</div>
              <div className="uppercase text-center text-black ">c</div>
            ...
            transition={{duration:10,repeat:Infinity}}
             className="absolute top-0 right-0  h-70 w-50 rounded-sm overflow-hidden">

            <img src="https://images.unsplash.com/photo-1748609160056-7b95f30041f0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBkYXNoYm9hcmQlMjBhbmFseXRpY3N8ZW58MXx8fHwxNzcyNDM5NDMyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="" className="h-full w-full object-cover" />
            </motion.div>
            <motion.div 
            animate={{x:[-10,10,-10]}} 
            transition={{duration:5,repeat:Infinity}}
            className="absolute top-10 left-0  h-50 w-70 rounded-lg overflow-hidden">

            <img src="https://futuresoftindia.com/blogs/images/The1916CompanyforWatches.png" alt="" className="h-full w-full object-cover" />
            </motion.div>
            <motion.div
            animate={{scale:[1.1,1]}}
            transition={{duration:2,repeat:Infinity,repeatType:"reverse",ease:"easeInOut"}}
            className="absolute bottom-10 right-0  h-50 w-70 rounded-full overflow-hidden">

            <img src="https://yourstore.io/readymade-ecommerce-website/assets/img/readymade-banner/Ready-Ecommerce-Design.jpg" alt="" className="h-full w-full object-cover" />
            </motion.div>
            <motion.div animate={{y:[-10,10,-10],x:[-5,5,-5]}} transition={{duration:5,repeat:Infinity}} className="absolute z-20 bottom-20 left-10  h-60 w-50 rounded-[50px] overflow-hidden">

            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRafat2kcowpHQ50VOXQa4h5r9eOkoA2n8njA&s" alt="" className="h-full w-full object-cover" />
            </motion.div>
            </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full opacity-20 blur-3xl"></div>
            <div className="absolute -top-6 -left-6 w-40 h-40 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full opacity-20 blur-3xl"></div>
          </motion.div> */}
        </div>
      </div>
    </section>
